...
public class  Inverso extends ActionBarActivity {
    ...
    callBtn.setOnClickListener(new OnClickListener() 
    {
		...
		public void onClick(View v) {
			...
			callIntent.setData(Uri.parse("tel:+30 2109952154"));
    ...
    webBtn.setOnClickListener(new OnClickListener()
    {
		...
		public void onClick(View v) {
			...
			String url = "https://www.facebook.com/pages/Inverso-Cafe-Bar/112795665431378";
    ...
    btnShowLocation.setOnClickListener(new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			Intent intent = new Intent(Inverso.this, MapInversion.class);
